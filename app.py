...
def about_tab(df2):
    ...
    if selected_profile_1 == "Striker":
        ...
        plot_title_1 = f"Central Midfield Metric Percentiles for {selected_player_1}"
        ...
        plot_title_1 = f"Strech 9 Metrics for {selected_player_1}"
    else:
        # Define columns and plot title for the default profile
        columns_1 = []
        plot_title_1 = f"Default Profile Metrics for {selected_player_1}"
    ...
    if selected_profile_2 == "Striker":
        ...
        plot_title_2 = f"Central Midfield Metric Percentiles for {selected_player_2}"
        ...
        plot_title = f"Right Back Metric Percentiles for {selected_player_2}"
        ...
        plot_title_2 = f"Strech 9 Metrics for {selected_player_2}"
    else:
        # Define columns and plot title for the default profile
        columns_2 = []
        plot_title_2 = f"Default Profile Metrics for {selected_player_2}"
