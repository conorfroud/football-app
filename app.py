...
def display_data("10_uIbAH8t-qM74VgWtxPuA363PNpj22sj5h9TULl5_Q"):
    # Create a connection object.
    conn = st.connection("gsheets", type=GSheetsConnection, spreadsheet_id="10_uIbAH8t-qM74VgWtxPuA363PNpj22sj5h9TULl5_Q")
