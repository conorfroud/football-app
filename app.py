...
# Filter the available profiles based on the allowed score types
    ...
    if selected_profile == "Striker":
        ...
        columns = ["Player Name", "PAdj Tackles (LB)", "PAdj Interceptions (LB)", "Tackle/Dribbled Past (LB)", "OBV Defensive Action (LB)", "Dribbled Past (LB)", "Successful Dribbles (LB)", "OBV Dribble & Carry (LB)", "Successful Crosses (LB)", "Key Passes (RB)", "Open Play xA (LB)", "OBV Pass (LB)", "Average Distance (LB)", "Top 5 PSV-99 (LB)"]
        plot_title = f"Left Back Metric Percentiles for {selected_player}"
    elif selected_profile == "Right Back":
        columns = ["Player Name", "PAdj Tackles (RB)", "PAdj Interceptions (RB)", "Tackle/Dribbled Past (RB)", "OBV Defensive Action (RB)", "Dribbled Past (RB)", "Successful Dribbles (RB)", "OBV Dribble & Carry (RB)", "Successful Crosses (RB)", "Key Passes (RB)", "Open Play xA (RB)", "OBV Pass (RB)", "Average Distance (RB)", "Top 5 PSV-99 (RB)"]
