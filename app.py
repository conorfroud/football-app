...
def main_tab(df2):
   ...
   # Define a dictionary that maps 'Score Type' to columns
    score_type_column_mapping = {
        ...
        'Progressive 8': ['Player Name', 'Age', 'Team', 'League', 'Stoke Score', 'Average Distance (8)', 'Top 5 PSV-99 (8)', 'Contract expires', 'Market value (millions)'],
        'Running 8': ['Player Name', 'Age', 'Team', 'League', 'Stoke Score', 'Average Distance (8)', 'Top 5 PSV-99 (8)', 'Contract expires', 'Market value (millions)'],
