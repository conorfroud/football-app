...
def about_tab(df2):
    ...
    if selected_profile == "Striker":
        columns = ["Player Name", "xG per 90", "Non-Pen Goals per 90", "Shots per 90", "player_season_obv_shot_90 Percentile", "xA per 90", "Dribble & Carry OBV", "PAdj Pressures", "Average Distance Percentile", "Top 5 PSV-99 Percentile"]
        ...
        columns = ["Player Name", "Average Distance (CAM)", "Top 5 PSV (CAM)", "OBV Dribble & Carry (CAM)", "Dribbles per 90 (CAM)",  "xA per 90 (CAM)", "OBV Pass per 90 (CAM)", "NP Shots per 90 (CAM)", "Non-Pen Goals per 90 (CAM)", "NP xG per 90 (CAM)"]
