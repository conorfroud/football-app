...
def main_tab(df2):
    ...
    min_stoke_score = float(df2['Stoke Score'].min())
    max_stoke_score = float(df2['Stoke Score'].max())
    ...
    stoke_range = st.sidebar.slider("Select Age Range", min_value=min_stoke_score, max_value=max_stoke_score, value=(min_stoke_score, max_stoke_score))
