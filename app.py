...
def main_tab(df2):
   ...
   # Define a dictionary that maps 'Score Type' to columns
    score_type_column_mapping = {
        ...
        'Stretch 9': ['Player Name', 'Age', 'Team', 'League', 'Stoke Score', 'Average Distance (S9)',	'Top 5 PSV-99 (S9)', 'Contract expires', 'Market value (millions)', 'xG (S9)', 'Non-Penalty Goals (S9)', 'Shots (S9)', 'OBV Shot (S9)', 'Open Play xA (S9)', 'OBV Dribble & Carry (S9)', 'PAdj Pressures (S9)', ],
