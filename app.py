...
def about_tab(df2):
    ...
    if selected_profile == "Forward Profile":
        ...
        columns = ["Player Name", "Average Distance Percentile", "Top 5 PSV-99 Percentile", "Dribble & Carry OBV", "Dribbles per 90 (W)",  "xA per 90", "Shots per 90", "Non-Pen Goals per 90", "xG per 90"]
