...
def main_tab(df2):
    ...
    score_type_column_mapping = {
        "Striker": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Winger": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value" , "L/R Footedness %"],
        "Attacking Midfield": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Central Midfield": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Defensive Midfield": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Left Back": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Right Back": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Centre Back": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Stretch 9": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Box Crashing Midfielder": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Dribbling Winger": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Creative Winger": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Goalscoring Wide Forward": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Creative 10": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Progressive 8": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Progressive 6": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Defensive 6": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Attacking LB": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Defensive LB": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Attacking RB": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Defensive RB": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Ball Playing Centre Back": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
        "Dominant Centre Back": ["Player Name", "Age", "Team", "League", "Position", "Player Season Minutes", "Hull City Score", "Contract Expires", "Market Value", "L/R Footedness %"],
    }
...
def player_stat_search(df):
    ...
    if 'Market Value' in df.columns:
        ...
        max_market_value = float(market_value_series.max())

        selected_market_value = st.sidebar.slider(
            'Select Market Value Range',
            min_value=min_market_value,
            max_value=max_market_value,
            value=(min_market_value, max_market_value)
    ...
    if selected_market_value is not None:
        filtered_df = filtered_df[
            pd.to_numeric(filtered_df['Market Value'], errors='coerce').between(
                selected_market_value[0], selected_market_value[1]
            )
        ]
    ...
    for stat in selected_stats:
        if stat not in always_included_columns and stat in filtered_df.columns:
            ...
            if numeric_stat.notna().any():
                min_stat = float(numeric_stat.min())
...
def shortlist_eleven():
    ...
    # Select top 5 players for each position based on some criteria (for example, confidence score)
    top_5_rb_players = rb_data.sort_values(by='Confidence Score', ascending=False).head(10)
    top_5_lb_players = lb_data.sort_values(by='Confidence Score', ascending=False).head(10)
    top_5_lw_players = lw_data.sort_values(by='Confidence Score', ascending=False).head(10)
    top_5_rw_players = rw_data.sort_values(by='Confidence Score', ascending=False).head(10)
...
def plot_players_on_pitch(rb_players_data, lb_players_data, lw_players_data, rw_players_data, dm_players_data, cm_players_data, am_players_data, st_players_data, left_cb_players_data, right_cb_players_data, data, column_names):
    ...
    for position in ['RB', 'LB', 'LW', 'RW', 'CDM', 'CM', 'AM', 'CF']:
        ax.annotate(position, xy=(positions_x[position], position_label_y[position]), xytext=(positions_x[position], position_label_y[position]),
                    textcoords="offset points", ha='center', va='center', color='black', fontsize=8, fontweight='bold')
    ...
    for position, players_data in zip(['RB', 'LB', 'LW', 'RW', 'CDM', 'CM', 'AM', 'CF'], [rb_players_data, lb_players_data, lw_players_data, rw_players_data, dm_players_data, cm_players_data, am_players_data, st_players_data]):
        for index, player in players_data.iterrows():
            ...
            start_y[position] -= 2.5

    # Annotate left-footed CBs
    offset_left_cb = 0
    ax.annotate('CB', xy=(21, 32), xytext=(21, 32), textcoords="offset points", ha='center', va='center', color='black', fontsize=8, fontweight='bold')
    for index, player in left_cb_players_data.iterrows():
        ax.annotate(player['Player'], xy=(21, 30), xytext=(21, 30 + offset_left_cb),
                    textcoords="offset points", ha='center', va='center', color='black', fontsize=5)
        offset_left_cb -= 15  # Adjust the offset for left-footed CBs
...
def dashboard_tab():
    # Page-wide CSS for THIS tab (safe to call inside the tab)
    st.markdown(
        """
        <style>
    ...
    # Top bar
    unit = st.session_state.get("unit", "First Team")
    topbar_html = f"""
    <div class="topbar">
      <span class="pill {'pillActive' if unit=='All Units' else ''}">All Units</span>
      <span class="pill {'pillActive' if unit=='First Team' else ''}">First Team</span>
      <span class="pill {'pillActive' if unit=='Academy' else ''}">Academy</span>
    ...
    # MIDDLE: My Tasks + My Appointments
    with col_mid:
        st.markdown(
            """
    ...
    # RIGHT: Shortlists + Interesting Matches
    with col_right:
        st.markdown(
            """
            <div class="card" style="min-height: 290px;">
...
def player_similarity_search(df):
    ...
    if 'Market Value' in df.columns:
        market_value_series = pd.to_numeric(df['Market Value'], errors='coerce')
        if market_value_series.notna().any():
            min_market_value = float(market_value_series.min())
            max_market_value = float(market_value_series.max())
    ...
    if selected_expiry_years and 'Contract Expires Year' in filtered_df.columns:
        filtered_df = filtered_df[
            filtered_df['Contract Expires Year'].isin(selected_expiry_years)
        ]
    ...
    # -------------------------------------------------
    # STEP 1: Select player first
    # -------------------------------------------------
    st.subheader("Step 1: Select Player")

    player_options_df = (
        filtered_df[['Player Name', 'Team', 'Season', 'position_1']]
        .drop_duplicates()
        .sort_values(['Player Name', 'Team', 'Season'])
        .reset_index(drop=True)
    )

    player_labels = player_options_df.apply(
        lambda x: f"{x['Player Name']} | {x['Team']} | {x['Season']} | {x['position_1']}",
        axis=1
    ).tolist()
    ...
    selected_player_row = player_options_df.iloc[player_labels.index(selected_player_label)]

    target_candidates = filtered_df[
        ...
        (filtered_df['position_1'] == selected_player_row['position_1'])
    ].copy()
    ...
    # -------------------------------------------------
    st.subheader("Step 2: Comparison Settings")

    same_position_only = st.checkbox(
        f"Only compare with {target_row['position_1']} players",
        value=True
    )

    comparison_df = filtered_df.copy()
    if same_position_only:
        comparison_df = comparison_df[comparison_df['position_1'] == target_row['position_1']]

    if comparison_df.empty:
        st.warning("No comparison players available.")
        return

    # -------------------------------------------------
    # STEP 3: Select stats after player/position
    # -------------------------------------------------
    st.subheader("Step 3: Select Stats")

    selectable_stats = [
        col for col in all_columns
        if col not in always_included_columns
        and col not in ["Contract Expires Year", "Contract Expires Date"]
    ]

    position_defaults = {
        "Centre Back": ["Aerial Duels Won %", "Interceptions", "Clearances"],
        "Center Back": ["Aerial Duels Won %", "Interceptions", "Clearances"],
        "Full Back": ["Crosses", "Progressive Runs", "Tackles"],
        "Left Back": ["Crosses", "Progressive Runs", "Tackles"],
        "Right Back": ["Crosses", "Progressive Runs", "Tackles"],
        "Midfielder": ["Pass Completion %", "Progressive Passes", "Touches"],
        "Central Midfield": ["Pass Completion %", "Progressive Passes", "Touches"],
        "Defensive Midfield": ["Pass Completion %", "Interceptions", "Tackles"],
        "Attacking Midfield": ["Key Passes", "xA", "Progressive Passes"],
        "Winger": ["Dribbles", "xG", "Progressive Runs"],
        "Left Wing": ["Dribbles", "xG", "Progressive Runs"],
        "Right Wing": ["Dribbles", "xG", "Progressive Runs"],
        "Striker": ["xG", "Shots", "Goals"],
        "Centre Forward": ["xG", "Shots", "Goals"],
        "Center Forward": ["xG", "Shots", "Goals"]
    }

    default_stats = position_defaults.get(target_row['position_1'], [])
    default_stats = [s for s in default_stats if s in selectable_stats]

    selected_stats = st.multiselect(
        "Select stats for similarity",
        selectable_stats,
    ...
    # -------------------------------------------------
    # Optional stat sliders based on comparison group
    # -------------------------------------------------
    stat_min_max = {}
    for stat in selected_stats:
        if stat in comparison_df.columns:
            numeric_stat = pd.to_numeric(comparison_df[stat], errors='coerce')
            if numeric_stat.notna().any():
                stat_min_max[stat] = (float(numeric_stat.min()), float(numeric_stat.max()))

    with st.sidebar:
        st.markdown("### Selected Stat Filters")
    ...
    for stat, (min_val, max_val) in slider_filters.items():
        numeric_stat = pd.to_numeric(comparison_df[stat], errors='coerce')
        comparison_df = comparison_df[numeric_stat.between(min_val, max_val)]

    # Re-check target is still included after stat filters
    target_mask = (
        (comparison_df['Player Name'] == target_row['Player Name']) &
        (comparison_df['Team'] == target_row['Team']) &
        (comparison_df['Season'] == target_row['Season']) &
        (comparison_df['position_1'] == target_row['position_1'])
    )

    if not target_mask.any():
        st.warning("The selected player was removed by the stat range filters. Widen the ranges.")
        return

    if comparison_df.shape[0] < 2:
        st.warning("Not enough players remain for similarity comparison.")
        return

    # Refresh target row from filtered comparison set
    target_row = comparison_df[target_mask].iloc[0]

    # -------------------------------------------------
    # Lower-is-better config
    # -------------------------------------------------
    lower_is_better = {"Top 3 Time to Sprint"}

    # -------------------------------------------------
    # STEP 4: Calculate percentiles
    # Percentiles are computed within the comparison group
    # -------------------------------------------------
    valid_stats = []
    for stat in selected_stats:
        if stat in comparison_df.columns:
            ...
            if numeric_stat.notna().sum() > 1:
                ...
                comparison_df[f"{stat} Percentile"] = percentiles
                valid_stats.append(stat)

    if not valid_stats:
        st.warning("None of the selected stats have enough valid numeric data.")
        return

    percentile_cols = [f"{stat} Percentile" for stat in valid_stats]

    # Refresh target row again after percentile columns added
    target_mask = (
        (comparison_df['Player Name'] == target_row['Player Name']) &
        (comparison_df['Team'] == target_row['Team']) &
        (comparison_df['Season'] == target_row['Season']) &
    ...
    # STEP 5: Weights
    # -------------------------------------------------
    st.subheader("Step 4: Stat Weights")

    weights = {}
    weight_cols = st.columns(min(4, len(valid_stats)))
    ...
    # Weighted mean absolute percentile difference
    # Similarity = 100 - weighted average percentile gap
    # -------------------------------------------------
    ...
    for _, row in comparison_df.iterrows():
        ...
        if valid_mask.sum() == 0:
            ...
            avg_percentile_diffs.append(np.nan)
            stats_used_counts.append(0)
            continue
        ...
        avg_percentile_diffs.append(weighted_diff)
        stats_used_counts.append(valid_mask.sum())

    comparison_df['Similarity Score'] = similarity_scores
    comparison_df['Avg Percentile Difference'] = avg_percentile_diffs
    comparison_df['Stats Used'] = stats_used_counts

    # Remove target player from result list
    result_df = comparison_df.drop(index=target_row.name, errors='ignore')

    # Optional completeness rule
    min_valid_stats = st.slider(
        "Minimum number of selected stats required",
        min_value=1,
        max_value=len(valid_stats),
        value=max(1, min(3, len(valid_stats)))
    )
    result_df = result_df[result_df['Stats Used'] >= min_valid_stats]

    if result_df.empty:
        st.warning("No players remain after applying minimum stat coverage.")
        return
    ...
    target_summary_cols = [col for col in always_included_columns if col in comparison_df.columns]
    st.dataframe(
        pd.DataFrame([target_row[target_summary_cols]]),
        hide_index=True
    )
    ...
    profile_df = pd.DataFrame({
        ...
        "Weight": [weights[stat] for stat in valid_stats]
